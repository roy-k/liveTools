<template>
    <div>
        ...
        <vue-modal v-model="showModal" :backdrop="false">
            <div class="modal-4">
    ...
    methods: {
        ...
        drawRouletteWheel() {
            ...
            for (let i = 0; i < awards.length; i++) {
                ...
                context.translate(
                    CENTER_X +
                        Math.cos(_startRadian + awardRadian / 2) * TEXT_RADIUAS,
                    CENTER_Y +
                        Math.sin(_startRadian + awardRadian / 2) * TEXT_RADIUAS
                );
                context.rotate(_startRadian + awardRadian / 2 + Math.PI / 2);
                context.fillText(
                    awards[i].num,
                    -context.measureText(awards[i].num).width / 2,
                    0
                );
                context.restore();
